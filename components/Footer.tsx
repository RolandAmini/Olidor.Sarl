...
des aliments de complément, solutions nutritionnelles et les services logistiques intégrés. 
            ...
            <div className="flex gap-4 pt-4">
              <a 
                href="#" 
                className="w-10 h-10 bg-gray-800 hover:bg-green-700 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110"
                aria-label="LinkedIn"
              >
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+243123456789" className="text-gray-300 hover:text-green-700 transition-colors">
                  +243 999 209 710
                </a>
