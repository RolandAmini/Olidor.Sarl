      ...
      <div className="max-w-md w-full md:max-w-2xl lg:max-w-3xl">
        ...
        <div className="relative h-64 md:h-96 mb-8 md:mb-12">
          ...
          <div className="absolute bottom-8 right-12 md:right-24 animate-bounce" style={{ animationDelay: '1.5s', animationDuration: '3s' }}>
            <div className="w-14 h-14 md:w-22 md:h-22 lg:w-26 lg:h-26 bg-orange-400 rounded-full shadow-xl flex items-center justify-center text-3xl md:text-5xl lg:text-6xl">
              🥕
            </div>
          </div>
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            <div className="w-32 h-32 md:w-48 md:h-48 lg:w-56 lg:h-56 bg-white rounded-full shadow-2xl flex items-center justify-center overflow-hidden">
    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="px-4 md:px-8 lg:px-12 py-4 md:py-6">
          ...
          <div className="grid grid-cols-4 md:grid-cols-4 lg:grid-cols-8 gap-3 md:gap-4 lg:gap-6">
            {categories.map(cat => (
              <button
                key={cat.name}
                onClick={() => onNavigate('categories')}
      ...
      {/* Bottom Navigation */}
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 px-4 md:px-8 py-3 md:py-4 shadow-lg">
        <div className="flex justify-around items-center max-w-7xl mx-auto">
          <button className="flex flex-col items-center gap-1 text-green-600 hover:scale-110 transition-transform">
            <span className="text-2xl md:text-3xl">🏠</span>
            <span className="text-xs md:text-sm font-semibold">Accueil</span>
          </button>
          <button 
            onClick={() => onNavigate('categories')}
            className="flex flex-col items-center gap-1 text-gray-400 hover:text-gray-600 hover:scale-110 transition-all"
          >
            <span className="text-2xl md:text-3xl">📁</span>
            <span className="text-xs md:text-sm">Catégories</span>
          </button>
          <button className="flex flex-col items-center gap-1 text-gray-400 hover:text-gray-600 hover:scale-110 transition-all">
            <span className="text-2xl md:text-3xl">🛒</span>
            <span className="text-xs md:text-sm">Panier</span>
          </button>
          <button className="flex flex-col items-center gap-1 text-gray-400 hover:text-gray-600 hover:scale-110 transition-all">
            <span className="text-2xl md:text-3xl">📋</span>
            <span className="text-xs md:text-sm">Commandes</span>
          </button>
          <button className="flex flex-col items-center gap-1 text-gray-400 hover:text-gray-600 hover:scale-110 transition-all">
            <span className="text-2xl md:text-3xl">👤</span>
    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 px-4 md:px-8 py-3 md:py-4 shadow-lg">
        <div className="flex justify-around items-center max-w-7xl mx-auto">
          ...
          <button className="flex flex-col items-center gap-1 text-green-600 hover:scale-110 transition-transform">
            <span className="text-2xl md:text-3xl">📁</span>
            <span className="text-xs md:text-sm font-semibold">Catégories</span>
          </button>
          <button className="flex flex-col items-center gap-1 text-gray-400 hover:text-gray-600 hover:scale-110 transition-all">
            <span className="text-2xl md:text-3xl">🛒</span>
            <span className="text-xs md:text-sm">Panier</span>
...
export default function App() {
  ...
  return (
    <CartProvider>
      <div className="w-full min-h-screen bg-white md:bg-gray-100">
        <div className="max-w-md md:max-w-full mx-auto md:shadow-none bg-white">
